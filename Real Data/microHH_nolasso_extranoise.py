# Program: fit_nolasso_extranoise.py
# Purpose: runs the joint estimation procedure without lasso over the full variable set
...
# Run  model
## No lasso
res = run_simulations(n=n, k=k, q=q, eta=eta, lamb=lamb, T=T, A_in=A_in, Y_in=Y_in,
...
with open(str('microHHbinary_' + str(villno) + '_nolasso_'+ '_' + str(optimizer)+'_'+str(date) +'.pkl'), 'wb') as file: 
